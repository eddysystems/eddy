...
object Parse {
  ...
  def parseGen(G: Grammar, nop: Boolean = false): Code = {
    ...
    lazy val extra = List(
      ...
      "java.util.ArrayList",
      "scala._",
      "static tarski.ParseEddyActions._"
    ) map ("import "+_)
    lazy val preamble = "// Autogenerated by ambiguity: DO NOT EDIT!" :: ((G.preamble ++ extra) map javaPreamble)
