...
object ParseEddy {
  def parse(input: List[Token]): List[List[Stmt]] = {
    ...
    val P_Commas2_ExpAssignNC = mutable.Map[R,List[List[Exp]]]()
    val P_ExpAssign__ColonTok__ExpBinary = mutable.Map[R,List[(Exp,ColonTok,Exp)]]()
    val P_ExpHigh__LCurlyTok = mutable.Map[R,List[(Exp,LCurlyTok)]]()
    val P_Stmts__RCurlyTok = mutable.Map[R,List[(List[Stmt],RCurlyTok)]]()
    val P_Juxts2_ExpNew__RBrackTok = mutable.Map[R,List[(List[Exp],RBrackTok)]]()
    ...
    val P_ColonTok__ExpBinary = mutable.Map[R,List[(ColonTok,Exp)]]()
    val P_List_Type__GtTok = mutable.Map[R,List[(KList[Type],GtTok)]]()
    val P_Juxts2_ExpAssignNC = mutable.Map[R,List[List[Exp]]]()
    val P_ExpBinary__QuestionTok = mutable.Map[R,List[(Exp,QuestionTok)]]()
    val P_AssertTok__ExpJuxt = mutable.Map[R,List[(AssertTok,Exp)]]()
    val P_AssignOp = mutable.Map[R,List[Option[AssignOp]]]()
    val P_ExpJuxt__Block = mutable.Map[R,List[(Exp,List[Stmt])]]()
    ...
    val P_Commas2_ExpBinary__RParenTok = mutable.Map[R,List[(List[Exp],RParenTok)]]()
    val P_Option_TypeArgs__IdentTok = mutable.Map[R,List[(Option[KList[Type]],IdentTok)]]()
    val P_Juxts2_ExpNew = mutable.Map[R,List[List[Exp]]]()
    val P_Juxts2_ExpNew__RCurlyTok = mutable.Map[R,List[(List[Exp],RCurlyTok)]]()
    val P_PostOp = mutable.Map[R,List[UnaryOp]]()
    val P_CommaTok__Commas1_VarDecl = mutable.Map[R,List[(CommaTok,List[(NameDims,Option[Exp])])]]()
    val P_BinaryOp = mutable.Map[R,List[BinaryOp]]()
    val P_ExpHigh__DotTok = mutable.Map[R,List[(Exp,DotTok)]]()
    val P_Commas2_Type = mutable.Map[R,List[List[Type]]]()
    val P_CommaTok__Commas1_Type = mutable.Map[R,List[(CommaTok,List[Type])]]()
    val P_TypeArgs = mutable.Map[R,List[KList[Type]]]()
    val P_Option_TypeArgs = mutable.Map[R,List[Option[KList[Type]]]]()
    val P_Juxts2_VarDecl = mutable.Map[R,List[List[(NameDims,Option[Exp])]]]()
    val P_ExpBinary__RBrackTok = mutable.Map[R,List[(Exp,RBrackTok)]]()
    val P_ColonTok__ExpJuxt = mutable.Map[R,List[(ColonTok,Exp)]]()
    val P_ExpBinary__RCurlyTok = mutable.Map[R,List[(Exp,RCurlyTok)]]()
    val P_ExpHigh__LParenTok = mutable.Map[R,List[(Exp,LParenTok)]]()
    val P_Mod = mutable.Map[R,List[Mod]]()
    val P_Juxts1_Mod = mutable.Map[R,List[List[Mod]]]()
    val P_Juxts0_Mod = mutable.Map[R,List[List[Mod]]]()
    val P_List_ExpAssignNC__RCurlyTok = mutable.Map[R,List[(KList[Exp],RCurlyTok)]]()
    val P_RParenTok__ExpUnary = mutable.Map[R,List[(RParenTok,Exp)]]()
    ...
    val P_Commas1_VarDecl = mutable.Map[R,List[List[(NameDims,Option[Exp])]]]()
    val P_Juxts1_VarDecl = mutable.Map[R,List[List[(NameDims,Option[Exp])]]]()
    val P_EqTok__ExpCommas = mutable.Map[R,List[(EqTok,Exp)]]()
    val P_CommaTok__Commas1_ExpBinary = mutable.Map[R,List[(CommaTok,List[Exp])]]()
    val P_Juxts2_Type = mutable.Map[R,List[List[Type]]]()
    val P_LParenTok__Type = mutable.Map[R,List[(LParenTok,Type)]]()
    val P_CommaTok__Commas1_ExpAssignNC = mutable.Map[R,List[(CommaTok,List[Exp])]]()
    val P_Juxts2_ExpNew__RParenTok = mutable.Map[R,List[(List[Exp],RParenTok)]]()
    val P_List_ExpAssignNC__RParenTok = mutable.Map[R,List[(KList[Exp],RParenTok)]]()
    val P_AssignOp__ExpAssign = mutable.Map[R,List[(Option[AssignOp],Exp)]]()
    val P_Commas2_ExpBinary = mutable.Map[R,List[List[Exp]]]()
    val P_ExpHigh__LBrackTok = mutable.Map[R,List[(Exp,LBrackTok)]]()
    val P_Lit = mutable.Map[R,List[Lit]]()
    val P_ExpHighNA = mutable.Map[R,List[Exp]]()
    val P_ExpNewNA = mutable.Map[R,List[Exp]]()
    val P_Juxts1_ExpNewNA = mutable.Map[R,List[List[Exp]]]()
    val P_ExpHigh = mutable.Map[R,List[Exp]]()
    val P_ExpNew = mutable.Map[R,List[Exp]]()
    val P_ExpJuxt = mutable.Map[R,List[Exp]]()
    val P_Option_ExpJuxt = mutable.Map[R,List[Option[Exp]]]()
    val P_ExpUnary = mutable.Map[R,List[Exp]]()
    val P_ExpBinary = mutable.Map[R,List[Exp]]()
    val P_Commas1_ExpBinary = mutable.Map[R,List[List[Exp]]]()
    val P_ExpCommas = mutable.Map[R,List[Exp]]()
    val P_ExpAssign = mutable.Map[R,List[Exp]]()
    val P_ExpAssignNC = mutable.Map[R,List[Exp]]()
    val P_Juxts1_ExpAssignNC = mutable.Map[R,List[List[Exp]]]()
    val P_Commas1_ExpAssignNC = mutable.Map[R,List[List[Exp]]]()
    val P_List1_ExpAssignNC = mutable.Map[R,List[KList[Exp]]]()
    val P_List_ExpAssignNC = mutable.Map[R,List[KList[Exp]]]()
    val P_Option_TypeArgs__ExpJuxt = mutable.Map[R,List[(Option[KList[Type]],Exp)]]()
    val P_Juxts1_ExpNew = mutable.Map[R,List[List[Exp]]]()
    val P_ExpAssignNC__RParenTok = mutable.Map[R,List[(Exp,RParenTok)]]()
    val P_Block = mutable.Map[R,List[List[Stmt]]]()
    val P_StmtHelper = mutable.Map[R,List[Stmt]]()
    val P_Stmts = mutable.Map[R,List[List[Stmt]]]()
    val P_Commas2_ExpBinary__RBrackTok = mutable.Map[R,List[(List[Exp],RBrackTok)]]()
    val P_DotTok__IdentTok = mutable.Map[R,List[(DotTok,IdentTok)]]()
    val P_BinaryOp__ExpBinary = mutable.Map[R,List[(BinaryOp,Exp)]]()
    val P_ExpHigh__ColonColonTok = mutable.Map[R,List[(Exp,ColonColonTok)]]()
    val P_Commas2_VarDecl = mutable.Map[R,List[List[(NameDims,Option[Exp])]]]()
    val P_List1_VarDecl = mutable.Map[R,List[KList[(NameDims,Option[Exp])]]]()
    val P_Commas2_ExpBinary__RCurlyTok = mutable.Map[R,List[(List[Exp],RCurlyTok)]]()
    val P_List_ExpAssignNC__RBrackTok = mutable.Map[R,List[(KList[Exp],RBrackTok)]]()
    val P_Type = mutable.Map[R,List[Type]]()
    val P_Juxts1_Type = mutable.Map[R,List[List[Type]]]()
    val P_List1_Type = mutable.Map[R,List[KList[Type]]]()
    val P_List_Type = mutable.Map[R,List[KList[Type]]]()
    val P_Commas1_Type = mutable.Map[R,List[List[Type]]]()
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_Lit((lo,hi)) = t(P_StringLitTok)(x => StringLit(x.v)) ::: t(P_BoolLitTok)(x => BoolLit(x.v)) ::: t(P_LongLitTok)(x => LongLit(x.v)) ::: t(P_FloatLitTok)(x => FloatLit(x.v)) ::: t(P_IntLitTok)(x => IntLit(x.v)) ::: t(P_DoubleLitTok)(x => DoubleLit(x.v)) ::: t(P_NullLitTok)(x => NullLit()) ::: t(P_CharLitTok)(x => CharLit(x.v)); d("Lit",P_Lit)
      P_ExpHighNA((lo,hi)) = ss(P_ExpHigh__ColonColonTok,P_Option_TypeArgs__NewTok)((x,y) => NewRefExp(x._1,y._1)) ::: ss(P_ExpHigh,P_TypeArgs)((x,y) => TypeApplyExp(x,y)) ::: ss(P_ExpHigh__DotTok,P_Option_TypeArgs__IdentTok)((x,y) => FieldExp(x._1,y._1,y._2.name)) ::: t(P_IdentTok)(x => NameExp(x.name)) ::: ss(P_ExpHigh__LParenTok,P_List_ExpAssignNC__RParenTok)((x,y) => ApplyExp(x._1,y._1,ParenAround)) ::: ss(P_ExpHigh__LBrackTok,P_List_ExpAssignNC__RBrackTok)((x,y) => ApplyExp(x._1,y._1,BrackAround)) ::: ss(P_ExpHigh__ColonColonTok,P_Option_TypeArgs__IdentTok)((x,y) => MethodRefExp(x._1,y._1,y._2.name)) ::: ss(P_ExpHigh__LCurlyTok,P_List_ExpAssignNC__RCurlyTok)((x,y) => ApplyExp(x._1,y._1,CurlyAround)) ::: s(P_Lit)(x => LitExp(x)); d("ExpHighNA",P_ExpHighNA)
      P_ExpNewNA((lo,hi)) = s(P_ExpHighNA)(x => x) ::: ts(P_NewTok,P_Option_TypeArgs__ExpJuxt)((x,y) => NewExp(y._1,y._2)) ::: tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildExp(y)); d("ExpNewNA",P_ExpNewNA)
      ...
      P_ExpHigh((lo,hi)) = ts(P_LParenTok,P_ExpAssignNC__RParenTok)((x,y) => ParenExp(y._1)) ::: tt(P_LParenTok,P_RParenTok)((x,y) => ArrayExp(EmptyList, ParenAround)) ::: ts(P_LBrackTok,P_Juxts2_ExpNew__RBrackTok)((x,y) => ArrayExp(JuxtList(y._1), BrackAround)) ::: ts(P_LCurlyTok,P_Juxts2_ExpNew__RCurlyTok)((x,y) => ArrayExp(JuxtList(y._1), CurlyAround)) ::: ts(P_LParenTok,P_Juxts2_ExpNew__RParenTok)((x,y) => ArrayExp(JuxtList(y._1), ParenAround)) ::: ts(P_LBrackTok,P_Commas2_ExpBinary__RBrackTok)((x,y) => ArrayExp(CommaList(y._1), BrackAround)) ::: ts(P_LCurlyTok,P_Commas2_ExpBinary__RCurlyTok)((x,y) => ArrayExp(CommaList(y._1), CurlyAround)) ::: tt(P_LBrackTok,P_RBrackTok)((x,y) => ArrayExp(EmptyList, BrackAround)) ::: ts(P_LParenTok,P_Commas2_ExpBinary__RParenTok)((x,y) => ArrayExp(CommaList(y._1), ParenAround)) ::: ts(P_LCurlyTok,P_ExpBinary__RCurlyTok)((x,y) => ArrayExp(SingleList(y._1),CurlyAround)) ::: ts(P_LBrackTok,P_ExpBinary__RBrackTok)((x,y) => ArrayExp(SingleList(y._1),BrackAround)) ::: tt(P_LCurlyTok,P_RCurlyTok)((x,y) => ArrayExp(EmptyList, CurlyAround)) ::: s(P_ExpHighNA)(x => x); d("ExpHigh",P_ExpHigh)
      P_ExpNew((lo,hi)) = s(P_ExpHigh)(x => x) ::: ts(P_NewTok,P_Option_TypeArgs__ExpJuxt)((x,y) => NewExp(y._1,y._2)) ::: tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildExp(y)); d("ExpNew",P_ExpNew)
      P_ExpJuxt((lo,hi)) = s(P_ExpNew)(x => x) ::: ss(P_ExpNew,P_Juxts1_ExpNewNA)((x,y) => ApplyExp(x,JuxtList(y),NoAround)); d("ExpJuxt",P_ExpJuxt)
      P_Option_ExpJuxt((lo,hi)) = s(P_ExpJuxt)(x => Some(x)); d("Option_ExpJuxt",P_Option_ExpJuxt)
      P_ExpUnary((lo,hi)) = s(P_ExpJuxt)(x => x) ::: ss(P_ExpUnary,P_PostOp)((x,y) => UnaryExp(y,x)) ::: ss(P_PreOp,P_ExpUnary)((x,y) => UnaryExp(x,y)) ::: ss(P_LParenTok__Type,P_RParenTok__ExpUnary)((x,y) => CastExp(x._2,y._2)); d("ExpUnary",P_ExpUnary)
      P_ExpBinary((lo,hi)) = s(P_ExpUnary)(x => x) ::: ss(P_ExpBinary,P_BinaryOp__ExpBinary)((x,y) => BinaryExp(y._1,x,y._2)) ::: ss(P_ExpBinary__QuestionTok,P_ExpAssign__ColonTok__ExpBinary)((x,y) => CondExp(x._1,y._1,y._3)); d("ExpBinary",P_ExpBinary)
      ...
      P_ExpCommas((lo,hi)) = s(P_ExpBinary)(x => x) ::: s(P_Commas2_ExpBinary)(x => ArrayExp(CommaList(x),NoAround)); d("ExpCommas",P_ExpCommas)
      P_ExpAssign((lo,hi)) = s(P_ExpCommas)(x => x) ::: ss(P_ExpJuxt,P_AssignOp__ExpAssign)((x,y) => AssignExp(y._1,x,y._2)); d("ExpAssign",P_ExpAssign)
      P_ExpAssignNC((lo,hi)) = s(P_ExpBinary)(x => x) ::: ss(P_ExpJuxt,P_AssignOp__ExpAssign)((x,y) => AssignExp(y._1,x,y._2)); d("ExpAssignNC",P_ExpAssignNC)
      ...
      P_StmtHelper((lo,hi)) = ts(P_SynchronizedTok,P_ExpJuxt__Block)((x,y) => SyncStmt(y._1,y._2)) ::: s(P_ExpAssign)(x => ExpStmt(x)) ::: ss(P_AssertTok__ExpJuxt,P_ColonTok__ExpJuxt)((x,y) => AssertStmt(x._2,Some(y._2))) ::: ts(P_AssertTok,P_ExpJuxt)((x,y) => AssertStmt(y,None)) ::: s(P_Block)(x => BlockStmt(x)) ::: tn(P_ContinueTok,P_Option_IdentTok)((x,y) => ContinueStmt(y.map(_.name))) ::: tn(P_ReturnTok,P_Option_ExpJuxt)((x,y) => ReturnStmt(y)) ::: tn(P_BreakTok,P_Option_IdentTok)((x,y) => BreakStmt(y.map(_.name))) ::: ts(P_ThrowTok,P_ExpJuxt)((x,y) => ThrowStmt(y)) ::: ns(P_Juxts0_Mod,P_Type__List1_VarDecl)((x,y) => VarStmt(x,y._1,y._2)); d("StmtHelper",P_StmtHelper)
      ...
      P_Type((lo,hi)) = tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildType(y)) ::: ss(P_Type,P_LBrackTok__RBrackTok)((x,y) => ArrayType(x)) ::: t(P_IdentTok)(x => NameType(x.name)) ::: ss(P_Type,P_TypeArgs)((x,y) => ApplyType(x,y)) ::: ss(P_Type,P_DotTok__IdentTok)((x,y) => FieldType(x,y._2.name)) ::: ss(P_Mod,P_Type)((x,y) => ModType(x,y)); d("Type",P_Type)
