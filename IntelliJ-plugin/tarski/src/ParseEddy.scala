...
object ParseEddy {
  def parse(input: List[Token]): List[List[Stmt]] = {
    ...
    val P_List_Exp__RCurlyTok = mutable.Map[R,List[(KList[Exp],RCurlyTok)]]()
    val P_Mod = mutable.Map[R,List[Mod]]()
    val P_Juxts_Mod = mutable.Map[R,List[List[Mod]]]()
    ...
    val P_List02_Exp__RParenTok = mutable.Map[R,List[(KList[Exp],RParenTok)]]()
    ...
    val P_List2_Exp = mutable.Map[R,List[KList[Exp]]]()
    ...
    val P_List02_Exp = mutable.Map[R,List[KList[Exp]]]()
    ...
    for (lo <- 0 to n) {
      ...
      P_List_Exp__RCurlyTok((lo,lo)) = List()
      P_Mod((lo,lo)) = List()
      P_Juxts_Mod((lo,lo)) = List()
      ...
      P_List02_Exp__RParenTok((lo,lo)) = List()
      ...
      P_List02_Exp((lo,lo)) = List(EmptyList())
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_List_Exp__RCurlyTok((lo,hi)) = nt(P_List_Exp,P_RCurlyTok)((x,y) => (x,y)); d("List_Exp__RCurlyTok",P_List_Exp__RCurlyTok)
      ...
      P_Juxts_Mod((lo,hi)) = s(P_Mod)(x => List(x)) ::: ss(P_Mod,P_Juxts_Mod)((x,y) => x :: y); d("Juxts_Mod",P_Juxts_Mod)
      P_Juxts0_Mod((lo,hi)) = s(P_Juxts_Mod)(x => x); d("Juxts0_Mod",P_Juxts0_Mod)
      ...
      P_List_Exp__RBrackTok((lo,hi)) = nt(P_List_Exp,P_RBrackTok)((x,y) => (x,y)) ::: nt(P_List_Exp,P_RBrackTok)((x,y) => (x,y)); d("List_Exp__RBrackTok",P_List_Exp__RBrackTok)
      P_List02_Exp__RParenTok((lo,hi)) = nt(P_List02_Exp,P_RParenTok)((x,y) => (x,y)); d("List02_Exp__RParenTok",P_List02_Exp__RParenTok)
      ...
      P_CommaTok__Commas_Exp((lo,hi)) = ts(P_CommaTok,P_Commas_Exp)((x,y) => (x,y)) ::: ts(P_CommaTok,P_Commas_Exp)((x,y) => (x,y)); d("CommaTok__Commas_Exp",P_CommaTok__Commas_Exp)
      ...
      P_List02_Exp((lo,hi)) = s(P_List2_Exp)(x => x); d("List02_Exp",P_List02_Exp)
