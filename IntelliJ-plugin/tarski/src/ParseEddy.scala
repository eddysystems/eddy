...
object ParseEddy {
  def parse(input: List[Token]): List[List[AStmt]] = {
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_ForInfo((lo,hi)) = ss(P_Commas0_StmtHelperBS__SemiTok,P_Option_ExpAssign__SemiTok__Commas0_ExpAssignNC)((x,y) => (s: AStmt) => ForAStmt(x._1,y._1,y._3,s)) ::: ns(P_Juxts0_Mod__Option_Type,P_IdentDims__ForeachSep__ExpAssign)((x,y) => (s: AStmt) => ForeachAStmt(x._1,x._2,y._1._1,y._1._2,y._3,s)); d("ForInfo",P_ForInfo)
