...
object ParseEddy {
  def parse(input: List[Token]): List[List[AStmt]] = {
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_ExpRel_ExpJuxtNP((lo,hi)) = ss(P_ExpRel_ExpJuxt,P_GtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GtOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_GeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_InstanceofTok__Type)((x,y) => InstanceofAExp(x,y._2)) ::: s(P_ExpShift_ExpJuxtNP)(x => x) ::: ss(P_ExpRel_ExpJuxt,P_LeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_LtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LtOp(),x,y._2)); d("ExpRel_ExpJuxtNP",P_ExpRel_ExpJuxtNP)
      ...
      P_ExpRel_ExpJuxt((lo,hi)) = ss(P_ExpRel_ExpJuxt,P_GtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GtOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_GeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_InstanceofTok__Type)((x,y) => InstanceofAExp(x,y._2)) ::: s(P_ExpShift_ExpJuxt)(x => x) ::: ss(P_ExpRel_ExpJuxt,P_LeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_LtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LtOp(),x,y._2)); d("ExpRel_ExpJuxt",P_ExpRel_ExpJuxt)
      ...
      P_ExpRel_ExpNew((lo,hi)) = ss(P_ExpRel_ExpJuxt,P_GtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GtOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_GeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(GeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_InstanceofTok__Type)((x,y) => InstanceofAExp(x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_LeTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LeOp(),x,y._2)) ::: ss(P_ExpRel_ExpJuxt,P_LtTok__ExpShift_ExpJuxt)((x,y) => BinaryAExp(LtOp(),x,y._2)) ::: s(P_ExpShift_ExpNew)(x => x); d("ExpRel_ExpNew",P_ExpRel_ExpNew)
