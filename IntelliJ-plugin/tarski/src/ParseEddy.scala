...
object ParseEddy {
  def parse(input: List[Token]): List[List[AStmt]] = {
    ...
    val P_IfTok__LParenTok = mutable.Map[R,List[(IfTok,LParenTok)]]()
    ...
    val P_LParenTok__ExpAssign__RParenTok = mutable.Map[R,List[(LParenTok,AExp,RParenTok)]]()
    ...
    val P_LParenTok__ExpAssign = mutable.Map[R,List[(LParenTok,AExp)]]()
    ...
    val P_IfTok__LParenTok__ExpAssign = mutable.Map[R,List[(IfTok,LParenTok,AExp)]]()
    ...
    val P_ExpAssign__RParenTok__Option_DoTok = mutable.Map[R,List[(AExp,RParenTok,Option[DoTok])]]()
    val P_RParenTok__Option_ThenTok__Stmt = mutable.Map[R,List[(RParenTok,Option[ThenTok],AStmt)]]()
    ...
    val P_RParenTok__Option_ThenTok__MaybeStmt__ElseTok = mutable.Map[R,List[(RParenTok,Option[ThenTok],AStmt,ElseTok)]]()
    val P_PreOp = mutable.Map[R,List[UnaryOp]]()
    val P_ThenTok__MaybeStmt__ElseTok = mutable.Map[R,List[(ThenTok,AStmt,ElseTok)]]()
    val P_WhileUntil__LParenTok__ExpAssign = mutable.Map[R,List[(Boolean,LParenTok,AExp)]]()
    val P_ElseTok__Stmt = mutable.Map[R,List[(ElseTok,AStmt)]]()
    val P_Option_ThenTok__MaybeStmt__ElseTok__Stmt = mutable.Map[R,List[(Option[ThenTok],AStmt,ElseTok,AStmt)]]()
    val P_MaybeStmt__ElseTok__Stmt = mutable.Map[R,List[(AStmt,ElseTok,AStmt)]]()
    val P_DoTok__MaybeStmt__WhileUntil = mutable.Map[R,List[(DoTok,AStmt,Boolean)]]()
    val P_RParenTok__Option_DoTok__Stmt = mutable.Map[R,List[(RParenTok,Option[DoTok],AStmt)]]()
    val P_Commas2_ExpBinary__RParenTok = mutable.Map[R,List[(List[AExp],RParenTok)]]()
    val P_WhileUntil__LParenTok = mutable.Map[R,List[(Boolean,LParenTok)]]()
    ...
    val P_IfTok__LParenTok__ExpAssign__RParenTok = mutable.Map[R,List[(IfTok,LParenTok,AExp,RParenTok)]]()
    val P_MaybeStmt__ElseTok = mutable.Map[R,List[(AStmt,ElseTok)]]()
    val P_WhileUntil = mutable.Map[R,List[Boolean]]()
    val P_MaybeStmt__WhileUntil = mutable.Map[R,List[(AStmt,Boolean)]]()
    ...
    val P_ExpAssign__RParenTok__Option_ThenTok = mutable.Map[R,List[(AExp,RParenTok,Option[ThenTok])]]()
    ...
    val P_RParenTok__Option_ThenTok = mutable.Map[R,List[(RParenTok,Option[ThenTok])]]()
    ...
    val P_ExpUnaryNP = mutable.Map[R,List[AExp]]()
    val P_ExpBinaryNP = mutable.Map[R,List[AExp]]()
    val P_ExpAssignNP = mutable.Map[R,List[AExp]]()
    val P_ExpAssignNP__Option_DoTok = mutable.Map[R,List[(AExp,Option[DoTok])]]()
    ...
    val P_Option_ThenTok__MaybeStmt = mutable.Map[R,List[(Option[ThenTok],AStmt)]]()
    ...
    val P_RParenTok__Option_DoTok = mutable.Map[R,List[(RParenTok,Option[DoTok])]]()
    ...
    for (lo <- 0 to n) {
      ...
      P_IfTok__LParenTok__ExpAssign__RParenTok((lo,lo)) = List()
      P_MaybeStmt__ElseTok((lo,lo)) = List()
      P_WhileUntil((lo,lo)) = List()
      P_MaybeStmt__WhileUntil((lo,lo)) = List()
      P_Mod((lo,lo)) = List()
      ...
      P_ExpAssign__RParenTok__Option_ThenTok((lo,lo)) = List()
      ...
      P_RParenTok__Option_ThenTok((lo,lo)) = List()
      ...
      P_ExpUnaryNP((lo,lo)) = List()
      P_ExpBinaryNP((lo,lo)) = List()
      P_ExpAssignNP((lo,lo)) = List()
      P_ExpAssignNP__Option_DoTok((lo,lo)) = List()
      ...
      P_Option_ThenTok__MaybeStmt((lo,lo)) = List()
      ...
      P_RParenTok__Option_DoTok((lo,lo)) = List()
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_IfTok__LParenTok((lo,hi)) = tt(P_IfTok,P_LParenTok)((x,y) => (x,y)); d("IfTok__LParenTok",P_IfTok__LParenTok)
      ...
      P_LParenTok__ExpAssign__RParenTok((lo,hi)) = ts(P_LParenTok,P_ExpAssign__RParenTok)((x,y) => (x,y._1,y._2)); d("LParenTok__ExpAssign__RParenTok",P_LParenTok__ExpAssign__RParenTok)
      ...
      P_LParenTok__ExpAssign((lo,hi)) = ts(P_LParenTok,P_ExpAssign)((x,y) => (x,y)); d("LParenTok__ExpAssign",P_LParenTok__ExpAssign)
      ...
      P_IfTok__LParenTok__ExpAssign((lo,hi)) = ts(P_IfTok,P_LParenTok__ExpAssign)((x,y) => (x,y._1,y._2)); d("IfTok__LParenTok__ExpAssign",P_IfTok__LParenTok__ExpAssign)
      ...
      P_ExpAssign__RParenTok__Option_DoTok((lo,hi)) = ss(P_ExpAssign,P_RParenTok__Option_DoTok)((x,y) => (x,y._1,y._2)); d("ExpAssign__RParenTok__Option_DoTok",P_ExpAssign__RParenTok__Option_DoTok)
      P_RParenTok__Option_ThenTok__Stmt((lo,hi)) = ts(P_RParenTok,P_Option_ThenTok__Stmt)((x,y) => (x,y._1,y._2)); d("RParenTok__Option_ThenTok__Stmt",P_RParenTok__Option_ThenTok__Stmt)
      ...
      P_RParenTok__Option_ThenTok__MaybeStmt__ElseTok((lo,hi)) = ss(P_RParenTok__Option_ThenTok,P_MaybeStmt__ElseTok)((x,y) => (x._1,x._2,y._1,y._2)); d("RParenTok__Option_ThenTok__MaybeStmt__ElseTok",P_RParenTok__Option_ThenTok__MaybeStmt__ElseTok)
      ...
      P_WhileUntil__LParenTok__ExpAssign((lo,hi)) = ss(P_WhileUntil,P_LParenTok__ExpAssign)((x,y) => (x,y._1,y._2)); d("WhileUntil__LParenTok__ExpAssign",P_WhileUntil__LParenTok__ExpAssign)
      P_ElseTok__Stmt((lo,hi)) = ts(P_ElseTok,P_Stmt)((x,y) => (x,y)); d("ElseTok__Stmt",P_ElseTok__Stmt)
      P_Option_ThenTok__MaybeStmt__ElseTok__Stmt((lo,hi)) = ns(P_Option_ThenTok__MaybeStmt,P_ElseTok__Stmt)((x,y) => (x._1,x._2,y._1,y._2)); d("Option_ThenTok__MaybeStmt__ElseTok__Stmt",P_Option_ThenTok__MaybeStmt__ElseTok__Stmt)
      ...
      P_DoTok__MaybeStmt__WhileUntil((lo,hi)) = ts(P_DoTok,P_MaybeStmt__WhileUntil)((x,y) => (x,y._1,y._2)); d("DoTok__MaybeStmt__WhileUntil",P_DoTok__MaybeStmt__WhileUntil)
      P_RParenTok__Option_DoTok__Stmt((lo,hi)) = ts(P_RParenTok,P_Option_DoTok__Stmt)((x,y) => (x,y._1,y._2)); d("RParenTok__Option_DoTok__Stmt",P_RParenTok__Option_DoTok__Stmt)
      ...
      P_WhileUntil__LParenTok((lo,hi)) = st(P_WhileUntil,P_LParenTok)((x,y) => (x,y)); d("WhileUntil__LParenTok",P_WhileUntil__LParenTok)
      ...
      P_ExpParens((lo,hi)) = ts(P_LParenTok,P_ExpAssignNC__RParenTok)((x,y) => ParenAExp(y._1)) ::: tt(P_LParenTok,P_RParenTok)((x,y) => ArrayAExp(EmptyList, ParenAround)) ::: ts(P_LParenTok,P_Commas2_ExpBinary__RParenTok)((x,y) => ArrayAExp(CommaList(y._1), ParenAround)) ::: ts(P_LParenTok,P_Juxts2_ExpNew__RParenTok)((x,y) => ArrayAExp(JuxtList(y._1), ParenAround)); d("ExpParens",P_ExpParens)
      ...
      P_IfTok__LParenTok__ExpAssign__RParenTok((lo,hi)) = ss(P_IfTok__LParenTok,P_ExpAssign__RParenTok)((x,y) => (x._1,x._2,y._1,y._2)); d("IfTok__LParenTok__ExpAssign__RParenTok",P_IfTok__LParenTok__ExpAssign__RParenTok)
      ...
      P_MaybeStmt__WhileUntil((lo,hi)) = ns(P_MaybeStmt,P_WhileUntil)((x,y) => (x,y)); d("MaybeStmt__WhileUntil",P_MaybeStmt__WhileUntil)
      ...
      P_ExpAssign__RParenTok__Option_ThenTok((lo,hi)) = ss(P_ExpAssign,P_RParenTok__Option_ThenTok)((x,y) => (x,y._1,y._2)); d("ExpAssign__RParenTok__Option_ThenTok",P_ExpAssign__RParenTok__Option_ThenTok)
      ...
      P_RParenTok__Option_ThenTok((lo,hi)) = tn(P_RParenTok,P_Option_ThenTok)((x,y) => (x,y)); d("RParenTok__Option_ThenTok",P_RParenTok__Option_ThenTok)
      ...
      P_Ident((lo,hi)) = t(P_IdentTok)(x => x.name) ::: t(P_ThenTok)(x => "then") ::: t(P_UntilTok)(x => "until"); d("Ident",P_Ident)
      ...
      P_ExpHighNP((lo,hi)) = ts(P_LBrackTok,P_ExpBinary__RBrackTok)((x,y) => ArrayAExp(SingleList(y._1),BrackAround)) ::: tt(P_LBrackTok,P_RBrackTok)((x,y) => ArrayAExp(EmptyList, BrackAround)) ::: ts(P_LCurlyTok,P_Juxts2_ExpNew__RCurlyTok)((x,y) => ArrayAExp(JuxtList(y._1), CurlyAround)) ::: ts(P_LCurlyTok,P_Commas2_ExpBinary__RCurlyTok)((x,y) => ArrayAExp(CommaList(y._1), CurlyAround)) ::: ts(P_LBrackTok,P_Juxts2_ExpNew__RBrackTok)((x,y) => ArrayAExp(JuxtList(y._1), BrackAround)) ::: ts(P_LCurlyTok,P_ExpBinary__RCurlyTok)((x,y) => ArrayAExp(SingleList(y._1),CurlyAround)) ::: tt(P_LCurlyTok,P_RCurlyTok)((x,y) => ArrayAExp(EmptyList, CurlyAround)) ::: ts(P_LBrackTok,P_Commas2_ExpBinary__RBrackTok)((x,y) => ArrayAExp(CommaList(y._1), BrackAround)) ::: s(P_ExpHighNA)(x => x); d("ExpHighNP",P_ExpHighNP)
      ...
      P_ExpUnaryNP((lo,hi)) = s(P_ExpJuxtNP)(x => x) ::: ss(P_ExpUnary,P_PostOp)((x,y) => UnaryAExp(y,x)) ::: ss(P_PreOp,P_ExpUnary)((x,y) => UnaryAExp(x,y)) ::: ss(P_LParenTok__Type,P_RParenTok__ExpUnary)((x,y) => CastAExp(x._2,y._2)); d("ExpUnaryNP",P_ExpUnaryNP)
      P_ExpBinaryNP((lo,hi)) = s(P_ExpUnaryNP)(x => x) ::: ss(P_ExpBinary,P_BinaryOp__ExpBinary)((x,y) => BinaryAExp(y._1,x,y._2)) ::: ss(P_ExpBinary__QuestionTok,P_ExpAssign__ColonTok__ExpBinary)((x,y) => CondAExp(x._1,y._1,y._3)); d("ExpBinaryNP",P_ExpBinaryNP)
      P_ExpAssignNP((lo,hi)) = s(P_ExpBinaryNP)(x => x) ::: ss(P_ExpJuxt,P_AssignOp__ExpAssign)((x,y) => AssignAExp(y._1,x,y._2)); d("ExpAssignNP",P_ExpAssignNP)
      P_ExpAssignNP__Option_DoTok((lo,hi)) = sn(P_ExpAssignNP,P_Option_DoTok)((x,y) => (x,y)); d("ExpAssignNP__Option_DoTok",P_ExpAssignNP__Option_DoTok)
      ...
      P_StmtHelperBS((lo,hi)) = tn(P_BreakTok,P_Option_Ident)((x,y) => BreakAStmt(y)) ::: ss(P_IfTok__ExpAssignNP,P_ThenTok__Stmt)((x,y) => IfAStmt(x._2,y._2)) ::: ts(P_IfTok,P_ExpAssignNP)((x,y) => IfElseAStmt(y,EmptyAStmt(),HoleAStmt())) ::: ts(P_SynchronizedTok,P_ExpJuxt__Block)((x,y) => SyncAStmt(y._1,y._2)) ::: ts(P_ThrowTok,P_ExpJuxt)((x,y) => ThrowAStmt(y)) ::: ns(P_Juxts0_Mod,P_Type__List1_VarDecl)((x,y) => VarAStmt(x,y._1,y._2)) ::: ts(P_IfTok,P_ExpAssignNP)((x,y) => IfAStmt(y,EmptyAStmt())) ::: ts(P_AssertTok,P_ExpJuxt)((x,y) => AssertAStmt(y,None)) ::: tn(P_ContinueTok,P_Option_Ident)((x,y) => ContinueAStmt(y)) ::: ss(P_WhileUntil__ExpAssignNP,P_DoTok__Stmt)((x,y) => WhileAStmt(x._2,y._2,x._1)) ::: ss(P_IfTok__LParenTok__ExpAssign,P_RParenTok__Option_ThenTok__Stmt)((x,y) => IfAStmt(x._3,y._3)) ::: ss(P_DoTok__MaybeStmt,P_WhileUntil__ExpAssignNP)((x,y) => DoAStmt(x._2,y._2,y._1)) ::: s(P_ExpAssign)(x => ExpAStmt(x)) ::: ss(P_DoTok__MaybeStmt__WhileUntil,P_LParenTok__ExpAssign__RParenTok)((x,y) => DoAStmt(x._2,y._2,x._3)) ::: tn(P_ReturnTok,P_Option_ExpJuxt)((x,y) => ReturnAStmt(y)) ::: ss(P_AssertTok__ExpJuxt,P_ColonTok__ExpJuxt)((x,y) => AssertAStmt(x._2,Some(y._2))) ::: ss(P_WhileUntil__LParenTok__ExpAssign,P_RParenTok__Option_DoTok__Stmt)((x,y) => WhileAStmt(x._3,y._3,x._1)) ::: ss(P_IfTok__LParenTok__ExpAssign__RParenTok,P_Option_ThenTok__MaybeStmt__ElseTok__Stmt)((x,y) => IfElseAStmt(x._3,y._2,y._4)) ::: ss(P_IfTok__ExpAssignNP__ThenTok,P_MaybeStmt__ElseTok__Stmt)((x,y) => IfElseAStmt(x._2,y._1,y._3)) ::: ss(P_WhileUntil,P_ExpAssignNP)((x,y) => WhileAStmt(y,EmptyAStmt(),x)) ::: s(P_Block)(x => BlockAStmt(x)); d("StmtHelperBS",P_StmtHelperBS)
      P_StmtHelper((lo,hi)) = ss(P_IfTok__LParenTok__ExpAssign,P_RParenTok__Option_ThenTok__MaybeStmt__ElseTok)((x,y) => IfElseAStmt(x._3,y._3,HoleAStmt())) ::: ts(P_IfTok,P_ExpAssignNP__ThenTok)((x,y) => IfAStmt(y._1,HoleAStmt())) ::: ss(P_IfTok__LParenTok,P_ExpAssign__RParenTok__Option_ThenTok)((x,y) => IfAStmt(y._1,HoleAStmt())) ::: s(P_StmtHelperBS)(x => x) ::: ts(P_IfTok,P_ExpAssignNP)((x,y) => IfAStmt(y,HoleAStmt())) ::: ss(P_WhileUntil__LParenTok,P_ExpAssign__RParenTok__Option_DoTok)((x,y) => WhileAStmt(y._1,HoleAStmt(),x._1)) ::: ss(P_WhileUntil,P_ExpAssignNP__Option_DoTok)((x,y) => WhileAStmt(y._1,HoleAStmt(),x)) ::: ss(P_IfTok__ExpAssignNP,P_ThenTok__MaybeStmt__ElseTok)((x,y) => IfElseAStmt(x._2,y._2,HoleAStmt())); d("StmtHelper",P_StmtHelper)
      ...
      P_Option_ThenTok__MaybeStmt((lo,hi)) = nn(P_Option_ThenTok,P_MaybeStmt)((x,y) => (x,y)); d("Option_ThenTok__MaybeStmt",P_Option_ThenTok__MaybeStmt)
      ...
      P_RParenTok__Option_DoTok((lo,hi)) = tn(P_RParenTok,P_Option_DoTok)((x,y) => (x,y)); d("RParenTok__Option_DoTok",P_RParenTok__Option_DoTok)
