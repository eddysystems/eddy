...
object ParseEddy {
  def parse(input: List[Token]): List[List[AStmt]] = {
    ...
    for (lo <- 0 to n) {
      ...
      P_Right__ExpUnary_ExpJuxt((lo,lo)) = List()
      P_ExpCond_ExpNew__Right((lo,lo)) = List()
      P_RShiftTok__ExpAdd_ExpJuxt((lo,lo)) = List()
      P_ForInfo__Right__Stmt((lo,lo)) = List()
      P_SemiTok__Stmts((lo,lo)) = List()
      P_OrOrTok__ExpAndAnd_ExpJuxt((lo,lo)) = List()
      P_ExpHigh__Left((lo,lo)) = List()
      P_Type__List1_VarDecl((lo,lo)) = List()
      P_IdentDims__ForeachSep__ExpAssign((lo,lo)) = List()
      ...
      P_Commas2_ExpCond_ExpJuxt__Right((lo,lo)) = List()
      ...
      P_ForTok__Left((lo,lo)) = List()
      P_ExpAssign__Right((lo,lo)) = List()
      ...
      P_ExpAssignNC__Right((lo,lo)) = List()
      P_Right__Stmt((lo,lo)) = List()
      ...
      P_Right((lo,lo)) = List()
      P_List_ExpAssignNC__Right((lo,lo)) = List()
      P_Stmts__Right((lo,lo)) = List()
      P_Ident((lo,lo)) = List()
      ...
      P_Juxts2_ExpNew__Right((lo,lo)) = List()
    ...
    for (lo <- n to 0 by -1; hi <- lo+1 to n) {
      ...
      P_Right__ExpUnary_ExpJuxt((lo,hi)) = ss(P_Right,P_ExpUnary_ExpJuxt)((x,y) => (x,y)); d("Right__ExpUnary_ExpJuxt",P_Right__ExpUnary_ExpJuxt)
      P_ExpCond_ExpNew__Right((lo,hi)) = ss(P_ExpCond_ExpNew,P_Right)((x,y) => (x,y)); d("ExpCond_ExpNew__Right",P_ExpCond_ExpNew__Right)
      ...
      P_ForInfo__Right__Stmt((lo,hi)) = ss(P_ForInfo,P_Right__Stmt)((x,y) => (x,y._1,y._2)); d("ForInfo__Right__Stmt",P_ForInfo__Right__Stmt)
      ...
      P_ExpHigh__Left((lo,hi)) = ss(P_ExpHigh,P_Left)((x,y) => (x,y)); d("ExpHigh__Left",P_ExpHigh__Left)
      P_Type__List1_VarDecl((lo,hi)) = ss(P_Type,P_List1_VarDecl)((x,y) => (x,y)); d("Type__List1_VarDecl",P_Type__List1_VarDecl)
      P_IdentDims__ForeachSep__ExpAssign((lo,hi)) = ss(P_IdentDims,P_ForeachSep__ExpAssign)((x,y) => (x,y._1,y._2)); d("IdentDims__ForeachSep__ExpAssign",P_IdentDims__ForeachSep__ExpAssign)
      P_ForInfo((lo,hi)) = ns(P_Juxts0_Mod__Option_Type,P_IdentDims__ForeachSep__ExpAssign)((x,y) => Foreach(x._1,x._2,y._1._1,y._1._2,y._3)) ::: ss(P_Commas0_StmtHelperBS__SemiTok,P_Option_ExpAssign__SemiTok__Commas0_ExpAssignNC)((x,y) => For(x._1,y._1,y._3)); d("ForInfo",P_ForInfo)
      ...
      P_Commas2_ExpCond_ExpJuxt__Right((lo,hi)) = ss(P_Commas2_ExpCond_ExpJuxt,P_Right)((x,y) => (x,y)); d("Commas2_ExpCond_ExpJuxt__Right",P_Commas2_ExpCond_ExpJuxt__Right)
      ...
      P_ParenExp((lo,hi)) = ss(P_Left,P_ExpAssign__Right)((x,y) => (y._1,Grouped(x,y._2))); d("ParenExp",P_ParenExp)
      ...
      P_PostOp((lo,hi)) = t(P_MinusMinusTok)(x => PostDecOp) ::: t(P_PlusPlusTok)(x => PostIncOp); d("PostOp",P_PostOp)
      ...
      P_ExpParens((lo,hi)) = ts(P_LParenTok,P_Juxts2_ExpNew__Right)((x,y) => ArrayAExp(JuxtList(y._1), Grouped(Paren,y._2))) ::: ts(P_LParenTok,P_Commas2_ExpCond_ExpJuxt__Right)((x,y) => ArrayAExp(CommaList(y._1),Grouped(Paren,y._2))) ::: ts(P_LParenTok,P_Right)((x,y) => ArrayAExp(EmptyList, Grouped(Paren,y))) ::: ts(P_LParenTok,P_ExpAssignNC__Right)((x,y) => ParenAExp(y._1, Grouped(Paren,y._2))); d("ExpParens",P_ExpParens)
      ...
      P_LBrackTok__Right((lo,hi)) = ts(P_LBrackTok,P_Right)((x,y) => (x,y)); d("LBrackTok__Right",P_LBrackTok__Right)
      ...
      P_LeftNP((lo,hi)) = t(P_LCurlyTok)(x => Curly) ::: t(P_LBrackTok)(x => Brack); d("LeftNP",P_LeftNP)
      P_ExpAssignNP__ThenTok((lo,hi)) = st(P_ExpAssignNP,P_ThenTok)((x,y) => (x,y)); d("ExpAssignNP__ThenTok",P_ExpAssignNP__ThenTok)
      P_ForTok__Left((lo,hi)) = ts(P_ForTok,P_Left)((x,y) => (x,y)); d("ForTok__Left",P_ForTok__Left)
      P_ExpAssign__Right((lo,hi)) = ss(P_ExpAssign,P_Right)((x,y) => (x,y)); d("ExpAssign__Right",P_ExpAssign__Right)
      ...
      P_Left((lo,hi)) = t(P_LCurlyTok)(x => Curly) ::: t(P_LBrackTok)(x => Brack) ::: t(P_LParenTok)(x => Paren); d("Left",P_Left)
      P_WhileUntil((lo,hi)) = t(P_UntilTok)(x => true) ::: t(P_WhileTok)(x => false); d("WhileUntil",P_WhileUntil)
      P_Mod((lo,hi)) = t(P_AbstractTok)(x => Abstract) ::: ts(P_AtTok,P_Ident)((x,y) => Annotation(y)) ::: t(P_FinalTok)(x => Final) ::: t(P_StrictfpTok)(x => Strictfp) ::: t(P_TransientTok)(x => Transient) ::: t(P_StaticTok)(x => Static) ::: t(P_PublicTok)(x => Public) ::: t(P_SynchronizedTok)(x => Synchronized) ::: t(P_PrivateTok)(x => Private) ::: t(P_VolatileTok)(x => Volatile) ::: t(P_ProtectedTok)(x => Protected); d("Mod",P_Mod)
      P_Juxts1_Mod((lo,hi)) = ss(P_Mod,P_Juxts1_Mod)((x,y) => x :: y) ::: s(P_Mod)(x => List(x)); d("Juxts1_Mod",P_Juxts1_Mod)
      ...
      P_ExpAssignNC__Right((lo,hi)) = ss(P_ExpAssignNC,P_Right)((x,y) => (x,y)); d("ExpAssignNC__Right",P_ExpAssignNC__Right)
      P_Right__Stmt((lo,hi)) = ss(P_Right,P_Stmt)((x,y) => (x,y)); d("Right__Stmt",P_Right__Stmt)
      ...
      P_Block((lo,hi)) = ts(P_LCurlyTok,P_Stmts__Right)((x,y) => y._1); d("Block",P_Block)
      P_ThenTok__Stmt((lo,hi)) = ts(P_ThenTok,P_Stmt)((x,y) => (x,y)); d("ThenTok__Stmt",P_ThenTok__Stmt)
      P_Right((lo,hi)) = t(P_RCurlyTok)(x => Curly) ::: t(P_RBrackTok)(x => Brack) ::: t(P_RParenTok)(x => Paren); d("Right",P_Right)
      P_List_ExpAssignNC__Right((lo,hi)) = ns(P_List_ExpAssignNC,P_Right)((x,y) => (x,y)); d("List_ExpAssignNC__Right",P_List_ExpAssignNC__Right)
      P_Stmts__Right((lo,hi)) = ns(P_Stmts,P_Right)((x,y) => (x,y)); d("Stmts__Right",P_Stmts__Right)
      P_Ident((lo,hi)) = t(P_InTok)(x => "in") ::: t(P_UntilTok)(x => "until") ::: t(P_ThenTok)(x => "then") ::: t(P_IdentTok)(x => x.name); d("Ident",P_Ident)
      P_ExpHighNA((lo,hi)) = ss(P_ExpHigh__ColonColonTok,P_Option_TypeArgs__Ident)((x,y) => MethodRefAExp(x._1,y._1,y._2)) ::: ss(P_ExpHigh__DotTok,P_Option_TypeArgs__Ident)((x,y) => FieldAExp(x._1,y._1,y._2)) ::: ss(P_ExpHigh,P_TypeArgs)((x,y) => TypeApplyAExp(x,y)) ::: ss(P_ExpHigh__ColonColonTok,P_Option_TypeArgs__NewTok)((x,y) => NewRefAExp(x._1,y._1)) ::: s(P_Lit)(x => x) ::: s(P_Ident)(x => NameAExp(x)) ::: ss(P_ExpHigh__Left,P_List_ExpAssignNC__Right)((x,y) => ApplyAExp(x._1,y._1,Grouped(x._2,y._2))); d("ExpHighNA",P_ExpHighNA)
      P_ExpHighNP((lo,hi)) = ss(P_LeftNP,P_Right)((x,y) => ArrayAExp(EmptyList, Grouped(x,y))) ::: ss(P_LeftNP,P_Juxts2_ExpNew__Right)((x,y) => ArrayAExp(JuxtList(y._1), Grouped(x,y._2))) ::: ss(P_LeftNP,P_Commas2_ExpCond_ExpJuxt__Right)((x,y) => ArrayAExp(CommaList(y._1), Grouped(x,y._2))) ::: s(P_ExpHighNA)(x => x) ::: ss(P_LeftNP,P_ExpCond_ExpNew__Right)((x,y) => ArrayAExp(SingleList(y._1),Grouped(x,y._2))); d("ExpHighNP",P_ExpHighNP)
      P_ExpHigh((lo,hi)) = s(P_ExpHighNP)(x => x) ::: s(P_ExpParens)(x => x); d("ExpHigh",P_ExpHigh)
      P_ExpNew((lo,hi)) = tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildAExp(y)) ::: ts(P_NewTok,P_Option_TypeArgs__ExpJuxt)((x,y) => NewAExp(y._1,y._2)) ::: s(P_ExpHigh)(x => x); d("ExpNew",P_ExpNew)
      P_Juxts1_ExpNew((lo,hi)) = ss(P_ExpNew,P_Juxts1_ExpNew)((x,y) => x :: y) ::: s(P_ExpNew)(x => List(x)); d("Juxts1_ExpNew",P_Juxts1_ExpNew)
      P_ExpUnary_ExpNew((lo,hi)) = ss(P_LParenTok__Type,P_Right__ExpUnary_ExpJuxt)((x,y) => CastAExp(x._2,y._2)) ::: ss(P_PreOp,P_ExpUnary_ExpJuxt)((x,y) => UnaryAExp(x,y)) ::: ss(P_ExpUnary_ExpJuxt,P_PostOp)((x,y) => UnaryAExp(y,x)) ::: s(P_ExpNew)(x => x); d("ExpUnary_ExpNew",P_ExpUnary_ExpNew)
      P_ExpMul_ExpNew((lo,hi)) = ss(P_ExpMul_ExpJuxt,P_ModTok__ExpUnary_ExpNew)((x,y) => BinaryAExp(ModOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_DivTok__ExpUnary_ExpNew)((x,y) => BinaryAExp(DivOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_MulTok__ExpUnary_ExpNew)((x,y) => BinaryAExp(MulOp,x,y._2)) ::: s(P_ExpUnary_ExpNew)(x => x); d("ExpMul_ExpNew",P_ExpMul_ExpNew)
      P_ExpAdd_ExpNew((lo,hi)) = ss(P_ExpAdd_ExpJuxt,P_MinusTok__ExpMul_ExpNew)((x,y) => BinaryAExp(SubOp,x,y._2)) ::: ss(P_ExpAdd_ExpJuxt,P_PlusTok__ExpMul_ExpNew)((x,y) => BinaryAExp(AddOp,x,y._2)) ::: s(P_ExpMul_ExpNew)(x => x); d("ExpAdd_ExpNew",P_ExpAdd_ExpNew)
      P_ExpShift_ExpNew((lo,hi)) = ss(P_ExpShift_ExpJuxt,P_UnsignedRShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(UnsignedRShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_RShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(RShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_LShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(LShiftOp,x,y._2)) ::: s(P_ExpAdd_ExpNew)(x => x); d("ExpShift_ExpNew",P_ExpShift_ExpNew)
      ...
      P_ExpEq_ExpNew((lo,hi)) = ss(P_ExpEq_ExpJuxt,P_NeTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(NeOp,x,y._2)) ::: ss(P_ExpEq_ExpJuxt,P_EqEqTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(EqOp,x,y._2)) ::: s(P_ExpRel_ExpNew)(x => x); d("ExpEq_ExpNew",P_ExpEq_ExpNew)
      P_ExpAnd_ExpNew((lo,hi)) = ss(P_ExpAnd_ExpJuxt,P_AndTok__ExpEq_ExpJuxt)((x,y) => BinaryAExp(AndOp,x,y._2)) ::: s(P_ExpEq_ExpNew)(x => x); d("ExpAnd_ExpNew",P_ExpAnd_ExpNew)
      P_ExpXor_ExpNew((lo,hi)) = ss(P_ExpXor_ExpJuxt,P_XorTok__ExpAnd_ExpJuxt)((x,y) => BinaryAExp(XorOp,x,y._2)) ::: s(P_ExpAnd_ExpNew)(x => x); d("ExpXor_ExpNew",P_ExpXor_ExpNew)
      P_ExpOr_ExpNew((lo,hi)) = ss(P_ExpOr_ExpJuxt,P_OrTok__ExpXor_ExpJuxt)((x,y) => BinaryAExp(OrOp,x,y._2)) ::: s(P_ExpXor_ExpNew)(x => x); d("ExpOr_ExpNew",P_ExpOr_ExpNew)
      P_ExpAndAnd_ExpNew((lo,hi)) = ss(P_ExpAndAnd_ExpJuxt,P_AndAndTok__ExpOr_ExpJuxt)((x,y) => BinaryAExp(AndAndOp,x,y._2)) ::: s(P_ExpOr_ExpNew)(x => x); d("ExpAndAnd_ExpNew",P_ExpAndAnd_ExpNew)
      P_ExpOrOr_ExpNew((lo,hi)) = ss(P_ExpOrOr_ExpJuxt,P_OrOrTok__ExpAndAnd_ExpJuxt)((x,y) => BinaryAExp(OrOrOp,x,y._2)) ::: s(P_ExpAndAnd_ExpNew)(x => x); d("ExpOrOr_ExpNew",P_ExpOrOr_ExpNew)
      P_ExpCond_ExpNew((lo,hi)) = ss(P_ExpOrOr_ExpJuxt__QuestionTok,P_ExpAssign__ColonTok__ExpCond_ExpJuxt)((x,y) => CondAExp(x._1,y._1,y._3)) ::: s(P_ExpOrOr_ExpNew)(x => x); d("ExpCond_ExpNew",P_ExpCond_ExpNew)
      P_ExpJuxt((lo,hi)) = ss(P_ExpNew,P_SingleJuxt1_ExpNewNA)((x,y) => ApplyAExp(x,y,NoAround)) ::: s(P_ExpNew)(x => x); d("ExpJuxt",P_ExpJuxt)
      P_ExpUnary_ExpJuxt((lo,hi)) = ss(P_LParenTok__Type,P_Right__ExpUnary_ExpJuxt)((x,y) => CastAExp(x._2,y._2)) ::: ss(P_PreOp,P_ExpUnary_ExpJuxt)((x,y) => UnaryAExp(x,y)) ::: ss(P_ExpUnary_ExpJuxt,P_PostOp)((x,y) => UnaryAExp(y,x)) ::: s(P_ExpJuxt)(x => x); d("ExpUnary_ExpJuxt",P_ExpUnary_ExpJuxt)
      P_ExpMul_ExpJuxt((lo,hi)) = ss(P_ExpMul_ExpJuxt,P_ModTok__ExpUnary_ExpJuxt)((x,y) => BinaryAExp(ModOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_DivTok__ExpUnary_ExpJuxt)((x,y) => BinaryAExp(DivOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_MulTok__ExpUnary_ExpJuxt)((x,y) => BinaryAExp(MulOp,x,y._2)) ::: s(P_ExpUnary_ExpJuxt)(x => x); d("ExpMul_ExpJuxt",P_ExpMul_ExpJuxt)
      P_ExpAdd_ExpJuxt((lo,hi)) = ss(P_ExpAdd_ExpJuxt,P_MinusTok__ExpMul_ExpJuxt)((x,y) => BinaryAExp(SubOp,x,y._2)) ::: ss(P_ExpAdd_ExpJuxt,P_PlusTok__ExpMul_ExpJuxt)((x,y) => BinaryAExp(AddOp,x,y._2)) ::: s(P_ExpMul_ExpJuxt)(x => x); d("ExpAdd_ExpJuxt",P_ExpAdd_ExpJuxt)
      P_ExpShift_ExpJuxt((lo,hi)) = ss(P_ExpShift_ExpJuxt,P_UnsignedRShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(UnsignedRShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_RShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(RShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_LShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(LShiftOp,x,y._2)) ::: s(P_ExpAdd_ExpJuxt)(x => x); d("ExpShift_ExpJuxt",P_ExpShift_ExpJuxt)
      ...
      P_ExpEq_ExpJuxt((lo,hi)) = ss(P_ExpEq_ExpJuxt,P_NeTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(NeOp,x,y._2)) ::: ss(P_ExpEq_ExpJuxt,P_EqEqTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(EqOp,x,y._2)) ::: s(P_ExpRel_ExpJuxt)(x => x); d("ExpEq_ExpJuxt",P_ExpEq_ExpJuxt)
      P_ExpAnd_ExpJuxt((lo,hi)) = ss(P_ExpAnd_ExpJuxt,P_AndTok__ExpEq_ExpJuxt)((x,y) => BinaryAExp(AndOp,x,y._2)) ::: s(P_ExpEq_ExpJuxt)(x => x); d("ExpAnd_ExpJuxt",P_ExpAnd_ExpJuxt)
      P_ExpXor_ExpJuxt((lo,hi)) = ss(P_ExpXor_ExpJuxt,P_XorTok__ExpAnd_ExpJuxt)((x,y) => BinaryAExp(XorOp,x,y._2)) ::: s(P_ExpAnd_ExpJuxt)(x => x); d("ExpXor_ExpJuxt",P_ExpXor_ExpJuxt)
      P_ExpOr_ExpJuxt((lo,hi)) = ss(P_ExpOr_ExpJuxt,P_OrTok__ExpXor_ExpJuxt)((x,y) => BinaryAExp(OrOp,x,y._2)) ::: s(P_ExpXor_ExpJuxt)(x => x); d("ExpOr_ExpJuxt",P_ExpOr_ExpJuxt)
      P_ExpAndAnd_ExpJuxt((lo,hi)) = ss(P_ExpAndAnd_ExpJuxt,P_AndAndTok__ExpOr_ExpJuxt)((x,y) => BinaryAExp(AndAndOp,x,y._2)) ::: s(P_ExpOr_ExpJuxt)(x => x); d("ExpAndAnd_ExpJuxt",P_ExpAndAnd_ExpJuxt)
      P_ExpOrOr_ExpJuxt((lo,hi)) = ss(P_ExpOrOr_ExpJuxt,P_OrOrTok__ExpAndAnd_ExpJuxt)((x,y) => BinaryAExp(OrOrOp,x,y._2)) ::: s(P_ExpAndAnd_ExpJuxt)(x => x); d("ExpOrOr_ExpJuxt",P_ExpOrOr_ExpJuxt)
      P_ExpCond_ExpJuxt((lo,hi)) = ss(P_ExpOrOr_ExpJuxt__QuestionTok,P_ExpAssign__ColonTok__ExpCond_ExpJuxt)((x,y) => CondAExp(x._1,y._1,y._3)) ::: s(P_ExpOrOr_ExpJuxt)(x => x); d("ExpCond_ExpJuxt",P_ExpCond_ExpJuxt)
      P_ExpAssignNC((lo,hi)) = ss(P_ExpJuxt,P_AssignOp__ExpAssign)((x,y) => AssignAExp(y._1,x,y._2)) ::: s(P_ExpCond_ExpJuxt)(x => x); d("ExpAssignNC",P_ExpAssignNC)
      P_List1_ExpAssignNC((lo,hi)) = s(P_Juxts2_ExpAssignNC)(x => JuxtList(x)) ::: s(P_Commas2_ExpAssignNC)(x => CommaList(x)) ::: s(P_ExpAssignNC)(x => SingleList(x)); d("List1_ExpAssignNC",P_List1_ExpAssignNC)
      P_List_ExpAssignNC((lo,hi)) = s(P_List1_ExpAssignNC)(x => x); d("List_ExpAssignNC",P_List_ExpAssignNC)
      P_Commas1_ExpAssignNC((lo,hi)) = ss(P_ExpAssignNC,P_CommaTok__Commas1_ExpAssignNC)((x,y) => x :: y._2) ::: s(P_ExpAssignNC)(x => List(x)); d("Commas1_ExpAssignNC",P_Commas1_ExpAssignNC)
      ...
      P_Type((lo,hi)) = tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildAExp(y)) ::: s(P_ExpHigh)(x => x); d("Type",P_Type)
      P_Commas1_Type((lo,hi)) = ss(P_Type,P_CommaTok__Commas1_Type)((x,y) => x :: y._2) ::: s(P_Type)(x => List(x)); d("Commas1_Type",P_Commas1_Type)
      ...
      P_List1_Type((lo,hi)) = s(P_Juxts2_Type)(x => JuxtList(x)) ::: s(P_Commas2_Type)(x => CommaList(x)) ::: s(P_Type)(x => SingleList(x)); d("List1_Type",P_List1_Type)
      P_List_Type((lo,hi)) = s(P_List1_Type)(x => x); d("List_Type",P_List_Type)
      P_Juxts1_Type((lo,hi)) = ss(P_Type,P_Juxts1_Type)((x,y) => x :: y) ::: s(P_Type)(x => List(x)); d("Juxts1_Type",P_Juxts1_Type)
      P_ExpNewNP((lo,hi)) = tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildAExp(y)) ::: ts(P_NewTok,P_Option_TypeArgs__ExpJuxt)((x,y) => NewAExp(y._1,y._2)) ::: s(P_ExpHighNP)(x => x); d("ExpNewNP",P_ExpNewNP)
      P_ExpJuxtNP((lo,hi)) = ss(P_ExpNew,P_SingleJuxt1_ExpNewNA)((x,y) => ApplyAExp(x,y,NoAround)) ::: s(P_ExpNewNP)(x => x); d("ExpJuxtNP",P_ExpJuxtNP)
      P_ExpUnary_ExpJuxtNP((lo,hi)) = ss(P_LParenTok__Type,P_Right__ExpUnary_ExpJuxt)((x,y) => CastAExp(x._2,y._2)) ::: ss(P_PreOp,P_ExpUnary_ExpJuxt)((x,y) => UnaryAExp(x,y)) ::: ss(P_ExpUnary_ExpJuxt,P_PostOp)((x,y) => UnaryAExp(y,x)) ::: s(P_ExpJuxtNP)(x => x); d("ExpUnary_ExpJuxtNP",P_ExpUnary_ExpJuxtNP)
      P_ExpMul_ExpJuxtNP((lo,hi)) = ss(P_ExpMul_ExpJuxt,P_ModTok__ExpUnary_ExpJuxtNP)((x,y) => BinaryAExp(ModOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_DivTok__ExpUnary_ExpJuxtNP)((x,y) => BinaryAExp(DivOp,x,y._2)) ::: ss(P_ExpMul_ExpJuxt,P_MulTok__ExpUnary_ExpJuxtNP)((x,y) => BinaryAExp(MulOp,x,y._2)) ::: s(P_ExpUnary_ExpJuxtNP)(x => x); d("ExpMul_ExpJuxtNP",P_ExpMul_ExpJuxtNP)
      P_ExpAdd_ExpJuxtNP((lo,hi)) = ss(P_ExpAdd_ExpJuxt,P_MinusTok__ExpMul_ExpJuxtNP)((x,y) => BinaryAExp(SubOp,x,y._2)) ::: ss(P_ExpAdd_ExpJuxt,P_PlusTok__ExpMul_ExpJuxtNP)((x,y) => BinaryAExp(AddOp,x,y._2)) ::: s(P_ExpMul_ExpJuxtNP)(x => x); d("ExpAdd_ExpJuxtNP",P_ExpAdd_ExpJuxtNP)
      P_ExpShift_ExpJuxtNP((lo,hi)) = ss(P_ExpShift_ExpJuxt,P_UnsignedRShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(UnsignedRShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_RShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(RShiftOp,x,y._2)) ::: ss(P_ExpShift_ExpJuxt,P_LShiftTok__ExpAdd_ExpJuxt)((x,y) => BinaryAExp(LShiftOp,x,y._2)) ::: s(P_ExpAdd_ExpJuxtNP)(x => x); d("ExpShift_ExpJuxtNP",P_ExpShift_ExpJuxtNP)
      ...
      P_ExpEq_ExpJuxtNP((lo,hi)) = ss(P_ExpEq_ExpJuxt,P_NeTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(NeOp,x,y._2)) ::: ss(P_ExpEq_ExpJuxt,P_EqEqTok__ExpRel_ExpJuxt)((x,y) => BinaryAExp(EqOp,x,y._2)) ::: s(P_ExpRel_ExpJuxtNP)(x => x); d("ExpEq_ExpJuxtNP",P_ExpEq_ExpJuxtNP)
      P_ExpAnd_ExpJuxtNP((lo,hi)) = ss(P_ExpAnd_ExpJuxt,P_AndTok__ExpEq_ExpJuxt)((x,y) => BinaryAExp(AndOp,x,y._2)) ::: s(P_ExpEq_ExpJuxtNP)(x => x); d("ExpAnd_ExpJuxtNP",P_ExpAnd_ExpJuxtNP)
      P_ExpXor_ExpJuxtNP((lo,hi)) = ss(P_ExpXor_ExpJuxt,P_XorTok__ExpAnd_ExpJuxt)((x,y) => BinaryAExp(XorOp,x,y._2)) ::: s(P_ExpAnd_ExpJuxtNP)(x => x); d("ExpXor_ExpJuxtNP",P_ExpXor_ExpJuxtNP)
      P_ExpOr_ExpJuxtNP((lo,hi)) = ss(P_ExpOr_ExpJuxt,P_OrTok__ExpXor_ExpJuxt)((x,y) => BinaryAExp(OrOp,x,y._2)) ::: s(P_ExpXor_ExpJuxtNP)(x => x); d("ExpOr_ExpJuxtNP",P_ExpOr_ExpJuxtNP)
      P_ExpAndAnd_ExpJuxtNP((lo,hi)) = ss(P_ExpAndAnd_ExpJuxt,P_AndAndTok__ExpOr_ExpJuxt)((x,y) => BinaryAExp(AndAndOp,x,y._2)) ::: s(P_ExpOr_ExpJuxtNP)(x => x); d("ExpAndAnd_ExpJuxtNP",P_ExpAndAnd_ExpJuxtNP)
      P_ExpOrOr_ExpJuxtNP((lo,hi)) = ss(P_ExpOrOr_ExpJuxt,P_OrOrTok__ExpAndAnd_ExpJuxt)((x,y) => BinaryAExp(OrOrOp,x,y._2)) ::: s(P_ExpAndAnd_ExpJuxtNP)(x => x); d("ExpOrOr_ExpJuxtNP",P_ExpOrOr_ExpJuxtNP)
      P_ExpCond_ExpJuxtNP((lo,hi)) = ss(P_ExpOrOr_ExpJuxt__QuestionTok,P_ExpAssign__ColonTok__ExpCond_ExpJuxt)((x,y) => CondAExp(x._1,y._1,y._3)) ::: s(P_ExpOrOr_ExpJuxtNP)(x => x); d("ExpCond_ExpJuxtNP",P_ExpCond_ExpJuxtNP)
      P_ExpAssignNP((lo,hi)) = ss(P_ExpJuxt,P_AssignOp__ExpAssign)((x,y) => AssignAExp(y._1,x,y._2)) ::: s(P_ExpCond_ExpJuxtNP)(x => x); d("ExpAssignNP",P_ExpAssignNP)
      P_MaybeParenExp((lo,hi)) = s(P_ParenExp)(x => x) ::: s(P_ExpAssignNP)(x => (x,NoAround)); d("MaybeParenExp",P_MaybeParenExp)
      ...
      P_ExpNewNA((lo,hi)) = tn(P_QuestionTok,P_WildcardBounds)((x,y) => WildAExp(y)) ::: ts(P_NewTok,P_Option_TypeArgs__ExpJuxt)((x,y) => NewAExp(y._1,y._2)) ::: s(P_ExpHighNA)(x => x); d("ExpNewNA",P_ExpNewNA)
      P_Juxts1_ExpNewNA((lo,hi)) = ss(P_ExpNewNA,P_Juxts1_ExpNewNA)((x,y) => x :: y) ::: s(P_ExpNewNA)(x => List(x)); d("Juxts1_ExpNewNA",P_Juxts1_ExpNewNA)
      P_SingleJuxt1_ExpNewNA((lo,hi)) = s(P_Juxts2_ExpNewNA)(x => JuxtList(x)) ::: s(P_ExpNewNA)(x => SingleList(x)); d("SingleJuxt1_ExpNewNA",P_SingleJuxt1_ExpNewNA)
      ...
      P_IdentDims((lo,hi)) = ss(P_IdentDims,P_LBrackTok__Right)((x,y) => (x._1,x._2+1)) ::: s(P_Ident)(x => (x,0)); d("IdentDims",P_IdentDims)
      P_VarDecl((lo,hi)) = ss(P_IdentDims,P_EqTok__ExpCommas)((x,y) => (x._1,x._2,Some(y._2))) ::: s(P_IdentDims)(x => (x._1,x._2,None)); d("VarDecl",P_VarDecl)
      P_Juxts1_VarDecl((lo,hi)) = ss(P_VarDecl,P_Juxts1_VarDecl)((x,y) => x :: y) ::: s(P_VarDecl)(x => List(x)); d("Juxts1_VarDecl",P_Juxts1_VarDecl)
      P_Commas1_VarDecl((lo,hi)) = ss(P_VarDecl,P_CommaTok__Commas1_VarDecl)((x,y) => x :: y._2) ::: s(P_VarDecl)(x => List(x)); d("Commas1_VarDecl",P_Commas1_VarDecl)
      P_ForeachSep((lo,hi)) = t(P_InTok)(x => ()) ::: t(P_ColonTok)(x => ()); d("ForeachSep",P_ForeachSep)
      ...
      P_List1_VarDecl((lo,hi)) = s(P_Juxts2_VarDecl)(x => JuxtList(x)) ::: s(P_Commas2_VarDecl)(x => CommaList(x)) ::: s(P_VarDecl)(x => SingleList(x)); d("List1_VarDecl",P_List1_VarDecl)
      ...
      P_Juxts2_ExpNew__Right((lo,hi)) = ss(P_Juxts2_ExpNew,P_Right)((x,y) => (x,y)); d("Juxts2_ExpNew__Right",P_Juxts2_ExpNew__Right)
