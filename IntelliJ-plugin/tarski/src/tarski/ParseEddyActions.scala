...
object ParseEddyActions {
  ...
  def ExpHighNA0(x0: KList[AExp], x1: AExp): AExp = TypeApplyAExp(x1,x0)
  def ExpHighNA1(x0: AExp, x1: (Option[KList[AExp]],String)): AExp = FieldAExp(x0,x1._1,x1._2)
  def ExpHighNA2(x0: String): AExp = NameAExp(x0)
  ...
  def ExpHighNA5(x0: AExp, x1: (Option[KList[AExp]],String)): AExp = MethodRefAExp(x0,x1._1,x1._2)
  def ExpHighNA6(x0: AExp, x2: Option[KList[AExp]]): AExp = NewRefAExp(x0,x2)
  def ExpHighNA7(x0: AExp, x1: KList[AExp]): AExp = TypeApplyAExp(x0,x1)
  ...
  def ExpShift_ExpNew0(x0: AExp, x6: AExp): AExp = BinaryAExp(UnsignedRShiftOp,x0,x6)
  def ExpShift_ExpNew1(x0: AExp, x4: AExp): AExp = BinaryAExp(RShiftOp,x0,x4)
