...
object ParseEddyActions {
  ...
  def ExpOrOr_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(OrOrOp,x0,x2)
  def ExpOrOr_ExpWild1(x0: AExp): AExp = x0
  def ExpHighNA0(x0: (AExp,Group), x1: (KList[AExp],Group)): AExp = ApplyAExp(x0._1,x1._1,Grouped(x0._2,x1._2))
  ...
  def ExpAdd_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(SubOp,x0,x2)
  def ExpAdd_ExpWild1(x0: AExp, x2: AExp): AExp = BinaryAExp(AddOp,x0,x2)
  ...
  def ExpCond_ExpWild0(x0: AExp, x1: (AExp,AExp)): AExp = CondAExp(x0,x1._1,x1._2)
  ...
  def ExpWild0(x1: Option[(Bound,AExp)]): AExp = WildAExp(x1)
  ...
  def ExpShift_ExpJuxt0(x0: AExp, x6: AExp): AExp = BinaryAExp(UnsignedRShiftOp,x0,x6)
  def ExpShift_ExpJuxt1(x0: AExp, x4: AExp): AExp = BinaryAExp(RShiftOp,x0,x4)
  ...
  def ExpHighNP0(x0: Group, x1: (AExp,Group)): AExp = ArrayAExp(SingleList(x1._1),Grouped(x0,x1._2))
  def ExpHighNP1(x0: Group, x1: (List[AExp],Group)): AExp = ArrayAExp(JuxtList(x1._1), Grouped(x0,x1._2))
  ...
  def ExpAndAnd_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(AndAndOp,x0,x2)
  ...
  def ExpEq_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(NeOp,x0,x2)
  def ExpEq_ExpWild1(x0: AExp, x2: AExp): AExp = BinaryAExp(EqOp,x0,x2)
  ...
  def ExpWildNP0(x1: Option[(Bound,AExp)]): AExp = WildAExp(x1)
  ...
  def ExpShift_ExpJuxtNP0(x0: AExp, x6: AExp): AExp = BinaryAExp(UnsignedRShiftOp,x0,x6)
  def ExpShift_ExpJuxtNP1(x0: AExp, x4: AExp): AExp = BinaryAExp(RShiftOp,x0,x4)
  ...
  def ExpMul_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(ModOp,x0,x2)
  def ExpMul_ExpWild1(x0: AExp, x2: AExp): AExp = BinaryAExp(DivOp,x0,x2)
  def ExpMul_ExpWild2(x0: AExp, x2: AExp): AExp = BinaryAExp(MulOp,x0,x2)
  ...
  def Mod10(): Mod = Final
  def ExpPrimary0(x0: KList[AExp], x1: AExp): AExp = TypeApplyAExp(x1,x0)
  def ExpPrimary1(x0: AExp, x1: (Option[KList[AExp]],String)): AExp = FieldAExp(x0,x1._1,x1._2)
  def ExpPrimary2(x0: String): AExp = NameAExp(x0)
  def ExpPrimary3(x0: ALit): AExp = x0
  def ExpPrimary4(x0: AExp, x1: KList[AExp]): AExp = TypeApplyAExp(x0,x1)
  ...
  def ExpShift_ExpWild0(x0: AExp, x6: AExp): AExp = BinaryAExp(UnsignedRShiftOp,x0,x6)
  def ExpShift_ExpWild1(x0: AExp, x4: AExp): AExp = BinaryAExp(RShiftOp,x0,x4)
  def ExpShift_ExpWild2(x0: AExp, x2: AExp): AExp = BinaryAExp(LShiftOp,x0,x2)
  def ExpShift_ExpWild3(x0: AExp): AExp = x0
  def ExpOr_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(OrOp,x0,x2)
  ...
  def ExpNew0(x1: Option[KList[AExp]], x2: AExp): AExp = NewAExp(x1,x2)
  ...
  def ExpRel_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(LtOp,x0,x2)
  def ExpRel_ExpWild1(x0: AExp, x2: AExp): AExp = BinaryAExp(GtOp,x0,x2)
  def ExpRel_ExpWild2(x0: AExp, x2: AExp): AExp = InstanceofAExp(x0,x2)
  def ExpRel_ExpWild3(x0: AExp, x2: AExp): AExp = BinaryAExp(LeOp,x0,x2)
  def ExpRel_ExpWild4(x0: AExp, x2: AExp): AExp = BinaryAExp(GeOp,x0,x2)
  ...
  def ExpUnary_ExpWild0(x0: AExp, x1: (Group,AExp)): AExp = CastAExp(x0,x1._2)
  def ExpUnary_ExpWild1(x0: UnaryOp, x1: AExp): AExp = UnaryAExp(x0,x1)
  def ExpUnary_ExpWild2(x0: AExp, x1: UnaryOp): AExp = UnaryAExp(x1,x0)
  ...
  def ExpXor_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(XorOp,x0,x2)
  ...
  def ExpWildNA0(x1: Option[(Bound,AExp)]): AExp = WildAExp(x1)
  ...
  def ExpAnd_ExpWild0(x0: AExp, x2: AExp): AExp = BinaryAExp(AndOp,x0,x2)
