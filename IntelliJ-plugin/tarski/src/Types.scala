...
object Types {
  ...
  case object LongType    extends IntegralType { val box = LongItem.simple }
  case object FloatType   extends FloatingType { val box = FloatItem.simple }
