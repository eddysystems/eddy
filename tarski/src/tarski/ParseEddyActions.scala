...
object ParseEddyActions {
  ...
  def StmtHelperBS6(x2: AExp, x4: AStmt, x1r: Range): AStmt = SyncAStmt(x1r,x2,NoAround(x2.r),x4)
  ...
  def StmtHelperBS8(x1: (Long,AStmt), x2: (Loc[Boolean],(AExp,Around))): AStmt = DoAStmt(x1._1,x1._2,x2._1.r,x2._1.x,x2._2._1,x2._2._2)
  def StmtHelperBS9(x2: AExp, x4: AExp, x1r: Range, x3r: Range): AStmt = AssertAStmt(x1r,x2,Some((x3r:SRange,x4)))
  ...
  def StmtHelperBS13(x2: AExp, x3: AStmt, x1r: Range): AStmt = SyncAStmt(x1r,x2,NoAround(x2.r),x3)
