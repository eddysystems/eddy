...
object ParseEddyActions {
  ...
  def MaybeColon__MaybeStmt0(x2: AStmt): AStmt = x2
  ...
  def Type__MaybeColon__MaybeStmt0(x1: AExp, x2: AStmt): (AExp,AStmt) = (x1,x2)
  ...
  def ExpHighNA0(x1: (AExp,Loc[Group]), x2: (KList[AExp],Loc[Group])): AExp = /* null */ filterApplyArgs(x2._1)(ApplyAExp(x1._1,_,Around(x1._2,x2._2)))
  ...
  def ArrayInteriorN10(x1: List[AExp]): KList[AExp] = JuxtList2(x1)
  ...
  def List1_ExpAssignNC0(x1: List[AExp]): KList[AExp] = JuxtList2(x1)
  ...
  def List1_VarDecl0(x1: List[AVarDecl]): KList[AVarDecl] = JuxtList2(x1)
  ...
  def Ident__MaybeColon__MaybeStmt0(x1: Loc[String], x2: AStmt): (Loc[String],AStmt) = (x1,x2)
  ...
  def Right__ClassBody0(x1: Loc[Group], x2: AClassBody): (Loc[Group],AClassBody) = (x1,x2)
  def MaybeDo__Stmt0(x2: AStmt): AStmt = x2
  def ExpAssignNP__Then0(x1: AExp): AExp = x1
  def ExpOrOr_ExpJuxtNP0(x1: AExp, x3: AExp, x2r: Range): AExp = BinaryAExp(OrOrOp,x2r,x1,x3)
  def ExpOrOr_ExpJuxtNP1(x1: AExp): AExp = x1
  def StmtHelperBS0(x1: (Long,ForInfo), x2: AStmt): AStmt = ForAStmt(x1._1,x1._2,NoAround(x1._2.r),x2)
  def StmtHelperBS1(x1: AExp, x2: KList[AVarDecl]): AStmt = VarAStmt(Nil,Some(x1),x2)
  def StmtHelperBS2(x2: AExp, x1r: Range): AStmt = ThrowAStmt(x1r,x2)
  def StmtHelperBS3(x2: AStmt, x3: Loc[Group], x1r: Range): AStmt = ParenAStmt(x2,Around(Paren,x1r,x3))
  def StmtHelperBS4(x2: Option[Loc[String]], x1r: Range): AStmt = BreakAStmt(x1r,x2)
  def StmtHelperBS5(x1: (Long,AStmt), x2: (List[(CatchInfo,AStmt)],Option[(SRange,AStmt)])): AStmt = TryAStmt(x1._1,x1._2,x2._1,x2._2)
  def StmtHelperBS6(x1: (Long,Loc[Group],ForInfo), x2: (Loc[Group],AStmt)): AStmt = ForAStmt(x1._1,x1._3,Around(x1._2,x2._1),x2._2)
  def StmtHelperBS7(x1: Loc[Boolean], x2: AExp): AStmt = /* null */ { val er = x2.r; filterNoStartsWithParen[AStmt](x2)(WhileAStmt(x1.r,x1.x,_,NoAround(er),EmptyAStmt(er.after))) }
  def StmtHelperBS8(x2: AExp, x4: AExp, x1r: Range, x3r: Range): AStmt = AssertAStmt(x1r,x2,Some((x3r:SRange,x4)))
  def StmtHelperBS9(x1: (Long,AExp), x2: AStmt): AStmt = SyncAStmt(x1._1,x1._2,NoAround(x1._2.r),x2)
  ...
  def StmtHelperBS15(x2: AExp, x1r: Range): AStmt = AssertAStmt(x1r,x2,None)
  def StmtHelperBS16(x2: Option[AExp], x1r: Range): AStmt = ReturnAStmt(x1r,x2)
  def StmtHelperBS17(x1: (Long,(AExp,Around)), x2: AStmt): AStmt = SyncAStmt(x1._1,x1._2._1,x1._2._2,x2)
  def StmtHelperBS18(x2: Option[Loc[String]], x1r: Range): AStmt = ContinueAStmt(x1r,x2)
  def StmtHelperBS19(x1: (Long,AStmt), x2: (Loc[Boolean],(AExp,Around))): AStmt = DoAStmt(x1._1,x1._2,x2._1.r,x2._1.x,x2._2._1,x2._2._2)
  def StmtHelperBS20(x1: (Loc[Boolean],AExp), x2: AStmt): AStmt = WhileAStmt(x1._1.r,x1._1.x,x1._2,NoAround(x2.r),x2)
  ...
  def MaybeStmt__ElseTok__MaybeColon__Stmt0(x1: AStmt, x2: (Long,AStmt)): (AStmt,Long,AStmt) = (x1,x2._1,x2._2)
  def DoTok__MaybeColon__MaybeStmt0(x3: AStmt, x1r: Range): (Long,AStmt) = (x1r,x3)
  ...
  def SynchronizedTok__ExpAssignNP0(x2: AExp, x1r: Range): (Long,AExp) = (x1r,x2)
  ...
  def TryTok__MaybeColon__Stmt0(x3: AStmt, x1r: Range): (Long,AStmt) = (x1r,x3)
  def List_ExpAssignNC__Right__ClassBody0(x1: KList[AExp], x2: (Loc[Group],AClassBody)): (KList[AExp],Loc[Group],AClassBody) = (x1,x2._1,x2._2)
  ...
  def AfterIfB0(x1: AExp, x2: AStmt): PreIf = PreIf(ir => IfAStmt(ir,x1,NoAround(x1.r),x2))
  def AfterIfB1(x1: (AExp,Around), x2: (AStmt,Long,AStmt)): PreIf = PreIf(ir => IfElseAStmt(ir,x1._1,x1._2,x2._1,x2._2,x2._3))
  def AfterIfB2(x1: AExp): PreIf = { val er = x1.r; PreIf(ir => IfAStmt(ir,x1,NoAround(er),EmptyAStmt(er.after))) }
  def AfterIfB3(x1: (AExp,Around), x2: AStmt): PreIf = PreIf(ir => IfAStmt(ir,x1._1,x1._2,x2))
  ...
  def AfterIfB7(x1: AExp, x2: (AStmt,Long,AStmt)): PreIf = PreIf(ir => IfElseAStmt(ir,x1,NoAround(x1.r),x2._1,x2._2,x2._3))
  ...
  def ExpNew__Left0(x1: AExp, x2: Loc[Group]): (AExp,Loc[Group]) = (x1,x2)
  ...
  def MaybeThen0(x1r: Range, x2r: Range): Option[SRange] = Some(x1r union x2r)
  def MaybeThen1(x1r: Range): Option[SRange] = Some(x1r)
  def MaybeThen2(x1r: Range): Option[SRange] = Some(x1r)
  def MaybeThen3(): Option[SRange] = None
  ...
  def MaybeParenExp1(x1: AExp): (AExp,Around) = /* null */ { val a = NoAround(x1.r); filterNoStartsWithParen[(AExp,Around)](x1)((_,a)) }
  ...
  def ExpJuxt0(x1: AExp, x2: JuxtList[AExp]): AExp = /* null */ { val a = NoAround(x2.list.head.r union x2.list.last.r); filterJuxtApply(x1,x2)(ApplyAExp(x1,_,a)) }
  ...
  def ElseTok__MaybeColon__Stmt0(x3: AStmt, x1r: Range): (Long,AStmt) = (x1r,x3)
  ...
  def List1_Type0(x1: List[AExp]): KList[AExp] = JuxtList2(x1)
  ...
  def Then__Stmt0(x2: AStmt): AStmt = x2
  ...
  def ExpPrimary0(x1: AExp, x2: AClassBody): AExp = AAnonClassExp(x1,EmptyList,NoAround(x1.r.after),x2)
  def ExpPrimary1(x1: Loc[String]): AExp = NameAExp(x1.x,x1.r)
  def ExpPrimary2(x1: AExp, x2: (Long,Option[Grouped[KList[AExp]]],Loc[String])): AExp = FieldAExp(x1,x2._1,x2._2,x2._3.x,x2._3.r)
  def ExpPrimary3(x1: (AExp,Long,Option[Grouped[KList[AExp]]]), x2: (AExp,List[Grouped[Option[AExp]]])): AExp = NewAExp(Some(x1._1),x1._2,x1._3,x2._1,x2._2)
  def ExpPrimary4(x1: ALit): AExp = x1
  def ExpPrimary5(x1: AExp, x2: Grouped[KList[AExp]]): AExp = TypeApplyAExp(x1,x2.x,x2.a,after=true)
  def ExpPrimary6(x1: (AExp,Loc[Group]), x2: (KList[AExp],Loc[Group],AClassBody)): AExp = filterApplyArgs(x2._1)(AAnonClassExp(x1._1,_,Around(x1._2,x2._2),x2._3))
  ...
  def Right__MaybeDo__Stmt0(x1: Loc[Group], x2: AStmt): (Loc[Group],AStmt) = (x1,x2)
  ...
  def AfterIfA0(x1: AExp, x2: (AStmt,Long)): PreIf = PreIf(ir => IfElseAStmt(ir,x1,NoAround(x1.r),x2._1,x2._2,HoleAStmt(x2._2.after)))
  ...
  def StmtHelper1(x2: ForInfo, x1r: Range): AStmt = { val ir = x2.r; ForAStmt(x1r,x2,NoAround(ir),HoleAStmt(ir.after)) }
  def StmtHelper2(x2: (AExp,Around), x1r: Range): AStmt = SyncAStmt(x1r,x2._1,x2._2,HoleAStmt(x2._2.r.after))
  def StmtHelper3(x2: PreIf, x1r: Range): AStmt = x2(x1r)
  ...
  def StmtHelper5(x1: (Long,Loc[Group],ForInfo), x2: Loc[Group]): AStmt = ForAStmt(x1._1,x1._3,Around(x1._2,x2),HoleAStmt(x2.r.after))
  ...
  def CatchTok__Left__EllipsisTok__Right0(x2: Loc[Group], x4: Loc[Group], x1r: Range): (Long,Loc[Group],Loc[Group]) = (x1r,x2,x4)
  ...
  def MaybeDo1(x1r: Range): Option[SRange] = Some(x1r)
  def MaybeDo2(): Option[SRange] = None
  ...
  def Right3(r: Range): Loc[Group] = Loc(AnyGroup,r)
  ...
  def MaybeStmt__ElseTok__MaybeColon0(x1: AStmt, x2r: Range): (AStmt,Long) = (x1,x2r)
  def Ident__Right__MaybeColon__MaybeStmt0(x1: (Loc[String],Loc[Group]), x2: AStmt): (Loc[String],Loc[Group],AStmt) = (x1._1,x1._2,x2)
  def CatchBlock0(x1: (Long,Loc[Group],Loc[String],List[Loc[Mod]]), x2: (AExp,Loc[Group],AStmt)): (CatchInfo,AStmt) = (CatchInfo(x1._1,x1._4,Some(x2._1),Some(x1._3),Around(x1._2,x2._2),true),x2._3)
  def CatchBlock1(x1: (Long,Loc[Group],Loc[Group]), x2: AStmt): (CatchInfo,AStmt) = (CatchInfo(x1._1,Nil,None,None,Around(x1._2,x1._3),false),x2)
  def CatchBlock2(x1: (Long,Loc[String],List[Loc[Mod]]), x2: (AExp,AStmt)): (CatchInfo,AStmt) = (CatchInfo(x1._1,x1._3,Some(x2._1),Some(x1._2),NoAround(x1._2.r union x2._1.r),true),x2._2)
  def CatchBlock3(x1: (Long,List[Loc[Mod]],AExp), x2: (Loc[String],AStmt)): (CatchInfo,AStmt) = (CatchInfo(x1._1,x1._2,Some(x1._3),Some(x2._1),NoAround(x1._2.headOption.map(_.r).getOrElse(x1._3.r) union x2._1.r),false),x2._2)
  ...
  def ForeachSep3(x1r: Range, x2r: Range): Long = (x1r union x2r).raw
  ...
  def Right__MaybeDo0(x1: Loc[Group]): Loc[Group] = x1
  ...
  def ElifTok__MaybeColon__AfterIf0(x1: ElifTok, x3: PreIf, x1r: Range): (Loc[ElifTok],PreIf) = (Loc(x1,x1r),x3)
  ...
  def ForTok__ForInfo0(x2: ForInfo, x1r: Range): (Long,ForInfo) = (x1r,x2)
  def Type__Right0(x1: AExp, x2: Loc[Group]): (AExp,Loc[Group]) = (x1,x2)
  def WhileUntil__ExpAssignNP0(x1: Loc[Boolean], x2: AExp): (Loc[Boolean],AExp) = (x1,x2)
