...
object ParseEddyActions {
  ...
  def StmtHelperBS13(x0: AStmt): AStmt = x0
  ...
  def StmtHelperBS17(x1: (AExp,Around), x2: AStmt, r: Range): AStmt = SyncAStmt(x1._1,x2,x1._2,r)
  def StmtHelperBS18(x0: (Boolean,(AExp,Around)), x1: AStmt, r: Range): AStmt = WhileAStmt(x0._2._1,x1,x0._1,x0._2._2,r)
  def StmtHelperBS19(x1: ForInfo, x3: AStmt, r: Range): AStmt = ForAStmt(x1,x3,NoAround,r)
