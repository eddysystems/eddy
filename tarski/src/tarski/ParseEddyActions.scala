...
object ParseEddyActions {
  ...
  def StmtHelperBS14(x2: AExp, x3: AStmt, x1r: Range): AStmt = SyncAStmt(x1r,x2,NoAround(x2.r),x3)
  def StmtHelperBS15(x1: (Loc[Boolean],(AExp,Around)), x2: AStmt): AStmt = WhileAStmt(x1._1.r,x1._1.x,x1._2._1,x1._2._2,x2)
  def StmtHelperBS16(x2: PreIf, x1r: Range): AStmt = x2(x1r)
  def StmtHelperBS17(x1: AExp): AStmt = ExpAStmt(x1)
  def StmtHelperBS18(x2: AExp, x1r: Range): AStmt = AssertAStmt(x1r,x2,None)
  def StmtHelperBS19(x2: Option[AExp], x1r: Range): AStmt = ReturnAStmt(x1r,x2)
  def StmtHelperBS20(x1: (Long,(AExp,Around)), x2: AStmt): AStmt = SyncAStmt(x1._1,x1._2._1,x1._2._2,x2)
  def StmtHelperBS21(x2: Option[Loc[String]], x1r: Range): AStmt = ContinueAStmt(x1r,x2)
  def StmtHelperBS22(x1: (Long,Loc[Group],ForInfo), x2: (Loc[Group],AStmt)): AStmt = ForAStmt(x1._1,x1._3,Around(x1._2,x2._1),x2._2)
